...
namespace EDSU_SYSTEM.Data.Migrations
{
    ...
    [Migration("20231106151659_vc vacancy nationality and states")]
    partial class vcvacancynationalityandstates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EDSU_SYSTEM.Models.BursaryClearanceFresher", b =>
                {
                    ...
                    b.HasOne("EDSU_SYSTEM.Models.Applicant", "Students")
                        .WithMany()
                        .HasForeignKey("StudentId");
            ...
            modelBuilder.Entity("EDSU_SYSTEM.Models.JupebStudent", b =>
                {
                    b.HasOne("EDSU_SYSTEM.Models.Jupeb", "Applicants")
                        .WithMany()
                        .HasForeignKey("ApplicantId");
            ...
            modelBuilder.Entity("EDSU_SYSTEM.Models.Staff", b =>
                {
                    ...
                    b.HasOne("EDSU_SYSTEM.Models.TypeOfStaff", "Types")
                        .WithMany()
                        .HasForeignKey("Type");
